...
- Declare uma marcação HTML básica nele; [x]
- Modifique a linguagem para português do Brasil; [x]
- Remova as meta tags desnecessárias; [x]
- Modifique o title para "Exercício 01"; [x]
- E linke este arquivo, app.js, antes do fechamento da tag body. [x]
*/
